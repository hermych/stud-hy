...
<div class="formRegistro row">
  ...
  <div class="col-6">
    ...
    <div class="form-inline mb-3">
      <div class="form-group">
        <div class="col" style="padding-left: 0;">
          <label for="egresado">¿Ya egresaste?</label>
        </div>
        <select class="form-control" id="egresado" name="egresado">
    ...
    <div class="form-group">
      ...
      <input type="month" class="form-control" id="anio_egreso" name="anio_egreso">
    </div>
    <div class="form-group">
